...
- Optionally **2–4 one-line theme bullets** with counts, where the dash-part is a **one-line characterization you write yourself** from the theme's stories — NOT a pasted example fragment. Collapse near-duplicate keyword topics (ai/model/code/agent → human themes like "Models", "Agent tooling", "Coding") and Title-Case them.
