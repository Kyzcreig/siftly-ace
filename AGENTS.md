...
- MEASURED LIMITATION (live 2026-06-14, docs/reviews/reddit-rss-live-proof.md): datacenter IP allows ≈1 RSS fetch/rolling-window — multi-sub needs a RESIDENTIAL egress lane (egress-lanes skill). Best-effort, ≥1 sub/run. github-trending is the resilient source (200, ~14 net-new/run).
