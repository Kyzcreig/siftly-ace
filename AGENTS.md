...
- Tests: `scripts/__tests__/output-shadow.test.ts` (8). `npm run verify` exit 0 (TS 219/py 42/e2e 10/gold 4/4). `docs/eval/surfaced-items/` is gitignored (runtime provenance state).
